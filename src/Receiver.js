    ...
    const submitReceiver = async (e) => {
        ...
        try{
            ...
            if(isValid){
                ...
                let res = await axios.post(`${config.apiBaseUrl}/conduit/update-comment`, formVals, {
                            ...
                            <Form id="receiverForm" >
                                <Row>
                                    <Col lg={2} md={12}>
                                        ...
                                        <Col lg={10} md={12}>
                                            <Form.Control id="firstName" name="firstname" lg={6} type="text" placeholder="first name" required />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col lg={2} md={12}>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="lastName" name="lastname" lg={6} type="text" placeholder="last name" required />
                                    </Col>
                                </Row>
                                 <Row>
                                    <Col lg={2} md={12}>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="locality" name="locality" lg={6} type="text" placeholder="state abbreviation or town name" required />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col lg={2} md={12}>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="office" name="office" lg={6} type="text" placeholder="office" required />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col lg={2} md={12}>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="status" name="status" lg={6} type="text" placeholder="status: incumbant | challenger" required />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col lg={2} md={12}>
                                 ...
                                 <Row>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="website" name="website" lg={6} type="url" placeholder="main website" />
                                    </Col>
                                </Row>
                                 <Row>
                                    <Col lg={2} md={12}>
                                    ...
                                    <Col lg={10} md={12}>
                                            <Form.Control id="social" name="social" lg={6} type="text" placeholder="social media handles"/>
                                    </Col>
                                </Row>
                            </Form>
                        </Modal.Body>
